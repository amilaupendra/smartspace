...
/* ── Trust badge data ─────────────────────────────────────────────────── */
const trustBadges = [
  { icon: <BadgeCheck className="w-6 h-6 text-blue-600" />, label: 'Fully Insured' },
  { icon: <ShieldCheck className="w-6 h-6 text-blue-600" />, label: 'Police Checked Staff' },
  { icon: <Leaf className="w-6 h-6 text-blue-600" />, label: 'Eco-Friendly Products' },
  { icon: <ThumbsUp className="w-6 h-6 text-blue-600" />, label: 'Satisfaction Guaranteed' },
];
...
export default function HomePage() {
  return (
    <>
      <Head>
        <title>SmartSpace | Commercial Cleaning Perth &amp; Western Australia</title>
        <meta
          name="description"
        ...
        {/* Open Graph */}
        <meta property="og:title" content="SmartSpace | Commercial Cleaning Perth & WA" />
        <meta
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-gray-500 max-w-xl mx-auto">
                Specialised commercial cleaning for every type of business across Perth and WA.
              </p>
            </div>
        ...
        <section className="py-20 bg-gray-50">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-14">
              ...
              <p className="text-gray-500 max-w-xl mx-auto">
                Getting started with SmartSpace is simple. We handle everything so you
        ...
        <section className="bg-gradient-to-r from-blue-700 to-blue-500 py-20">
          <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-white">
            ...
            <p className="text-blue-100 text-lg mb-8 leading-relaxed">
              Book a free, no-obligation quote today. Our friendly team will tailor
              a cleaning plan that fits your schedule and budget.
            </p>
            <Link
              href="/contact"
